        ...
        for item in tqdm(data, desc=f"Inference: {os.path.basename(model_path)}"):
            ...
            messages = [{
                ...
                "content": (
                    ...
                    f"{question}\n\n"
                    "Please select **only one** of the given options as the answer.\n"
                    "**Do not provide any explanation or reasoning.**\n"
                    "Reply with the exact option text only, nothing else.\n"
                    "Example: XYZ WXY"
                )
            }]
...
if __name__ == "__main__":
    ...
    output_dir = '/home/one/Codes/LLaMA-Factory-main/results/rawModel_infer'
    merged_checkpoints = [
        # '/home/one/Codes/Qwen2-VL-Finetune-master/output/test_grpo/checkpoint-30',
        # '/home/one/Codes/Qwen2-VL-Finetune-master/output/test_grpo1/checkpoint-120'
        '/home/one/pretrained_model/Qwen2.5VL-7B-instruct',
        # '/home/one/Codes/Qwen2.5-VL/merged/qwen2_5vl_lora_sft_chk100',
    ]
